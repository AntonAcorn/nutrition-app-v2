package com.aiduparc.nutrition.security.model;
...
public class AuthAccountEntity {
    ...
    public UUID getNutritionUserId() {
        return nutritionUserId;
    }

    public void setNutritionUserId(UUID nutritionUserId) {
