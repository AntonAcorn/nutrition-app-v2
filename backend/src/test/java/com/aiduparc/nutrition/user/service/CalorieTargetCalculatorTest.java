...
class CalorieTargetCalculatorTest {
    ...
    void maleSedentaryMaintain() {
        BigDecimal result = CalorieTargetCalculator.calculate(30, "male", bd("180"), bd("80"), "sedentary", "maintain");
        assertThat(result).isEqualByComparingTo("2136");
    }

    @Test
    void maleSedentaryLose() {
        BigDecimal result = CalorieTargetCalculator.calculate(30, "male", bd("180"), bd("80"), "sedentary", "lose");
        assertThat(result).isEqualByComparingTo("1636");
    }

    @Test
    void maleSedentaryGain() {
        BigDecimal result = CalorieTargetCalculator.calculate(30, "male", bd("180"), bd("80"), "sedentary", "gain");
    ...
    void femaleLightlyActiveMaintain() {
        BigDecimal result = CalorieTargetCalculator.calculate(25, "female", bd("165"), bd("60"), "lightly_active", "maintain");
    ...
    void maleModeratelyActiveLose() {
        BigDecimal result = CalorieTargetCalculator.calculate(35, "male", bd("175"), bd("90"), "moderately_active", "lose");
    ...
    void femaleVeryActiveGain() {
        BigDecimal result = CalorieTargetCalculator.calculate(40, "female", bd("160"), bd("70"), "very_active", "gain");
